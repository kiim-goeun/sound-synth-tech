...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 749.0, 682.0, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 618.0, 544.0, 29.5, 22.0 ],
					"text" : "b 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 472.5, 667.0, 131.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.166666666666657, 40.0, 33.0, 22.0 ],
					"text" : "r dur"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 714.0, 651.0, 33.0, 22.0 ],
					"text" : "r dur"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 668.0, 461.0, 33.0, 22.0 ],
					"text" : "r dur"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 472.5, 733.16666316986084, 35.0, 22.0 ],
					"text" : "s dur"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 472.5, 699.16666316986084, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 689.0, 617.0, 19.0, 20.0 ],
					"text" : "= "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 706.0, 617.0, 138.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 618.0, 682.0, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 457.0, 108.5, 23.0, 20.0 ],
					"text" : "36"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 618.0, 651.0, 32.0, 22.0 ],
					"text" : "+ 36"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 618.0, 617.0, 66.0, 22.0 ],
					"text" : "random 48"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 595.0, 520.0, 18.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 618.0, 491.0, 69.0, 22.0 ],
					"text" : "metro 2000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 618.0, 456.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 714.0, 736.0, 58.0, 22.0 ],
					"text" : "s velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 617.5, 736.0, 67.0, 22.0 ],
					"text" : "s midi.note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 799.0, 62.0, 56.0, 22.0 ],
					"text" : "r velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 482.0, 62.0, 65.0, 22.0 ],
					"text" : "r midi.note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.666666666666657, 48.0, 132.0, 20.0 ],
...
, 			{
				"box" : 				{
					"hkeycolor" : [ 0.466667, 0.254902, 0.607843, 1.0 ],
					"id" : "obj-2",
					"maxclass" : "kslider",
					"numinlets" : 2,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 0, 198.471631205673788, 1.0, 0, 302.822695035461152, 0.553333333333333, 0, 922.790780141844721, 0.566666666666667, 0, 1154.000000000001137, 0.0, 0 ],
					"domain" : 1154.0,
					"id" : "obj-30",
					"maxclass" : "function",
					"numinlets" : 1,
